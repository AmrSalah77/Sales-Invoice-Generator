...
public class NewInvoiceHeaderDialog extends javax.swing.JDialog {
     ...
     */
    public NewInvoiceHeaderDialog(SIG_MainFrame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        this.parent = parent;
        nameDateCancel.setActionCommand("Cancel Header");
        nameDateCancel.addActionListener(this.parent.getController());
        nameDateSave.setActionCommand("Save Header");
        nameDateSave.addActionListener(this.parent.getController());
    }
